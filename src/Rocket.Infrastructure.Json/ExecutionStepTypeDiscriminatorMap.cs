...
namespace Rocket.Infrastructure.Json
{
    public static class ExecutionStepTypeDiscriminatorMap
    {
        public static readonly Dictionary<Type, string> TypeDiscriminatorMap = new()
        {
            ...
            { typeof(OllamaExtractTextExecutionStepSpecifics), "ollama_extract_text_execution" },
            { typeof(OllamaExtractProjectExecutionStepSpecifics), "ollama_extract_project_execution" },
            ...
            { typeof(NotionUploadProjectTaskExecutionStepSpecifics), "notion_upload_project_task_execution" },
