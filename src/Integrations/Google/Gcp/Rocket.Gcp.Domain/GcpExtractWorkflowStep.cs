...
namespace Rocket.Gcp.Domain
{
    ...
    {
        public override int[] InputTypes { get; set; } = GcpDomainConstants.GcpExtractInputTypes;

        public override int OutputType { get; set; } = GcpDomainConstants.GcpExtractOutputType;
